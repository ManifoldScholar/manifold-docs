...
While you're at it, go ahead and create an admin user. Be sure to replace the values in the command below with your email, password, first name, and last name. For bash users, the backslash characters are not needed before the square brackets.
...
##########################################################################################
# Sample config for local development using an nginx proxy
##########################################################################################
...
Open a web browser and go to [http://127.0.0.1:3010](http://127.0.0.1:3010). If all went according to plan, you can now interact with the instance of Manifold running locally. You should now be able to login to the backend with the user you setup earlier.

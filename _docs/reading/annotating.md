...
<!-- INCLUDE NOTES ABOUT THE ANNOTATE BUTTON -->
...
<strong>Note</strong>. You need to have an account on the Manifold instance in question and be logged in, in order to see the Manage Groups option from the Profile dropdown.
</div>
...
To remove a reader from a group see the [Managing Your Reading Groups](/docs/reading/annotating.html#manage-groups) section.
...
To ensure other moderators do not intrude on your group, we suggest employing an invitation code not easily guessed by others.
...
- Edit Group allows you to adjust any settings there were codified at the outset.
- See All Members allows members to leave, moderators to remove, and everyone to see what other members have done in the group
- Main page allows mods and members to see where annotations have been placed across the instance with sorting for texts and group members.
- Generally note the high-level info provided at the top of the page.
- In the Annotation section at the start indicate how groups can be selected.

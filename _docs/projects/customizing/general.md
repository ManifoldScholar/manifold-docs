...
Standalone Mode renders Manifold projects as distinct microsites. The standard Manifold landing page that showcases [collections of projects](/docs/projects/collections.html)—or a publisher's entire content library—is not always appropriate or useful.
